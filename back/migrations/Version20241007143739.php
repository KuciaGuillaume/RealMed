 ...
 */
final class Version20241007143739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medicine (id INT NOT NULL, molecule_id INT DEFAULT NULL, dosage VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_58362A8DDAFCA214 ON medicine (molecule_id)');
        $this->addSql('CREATE TABLE molecule (id INT NOT NULL, PRIMARY KEY(id))');
